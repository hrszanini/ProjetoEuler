...
/*
 * Um número palíndromo se lê da mesma forma em qualquer direção. O maior
 * palíndromo produzido do produto de dois números de 2 algarismos é 9009 = 91
 * × 99. Encontre o maior palíndromo produzido do produto de dois números de 3
 * algarismos.
 */
...
int ePalidromo(int numero) { return numero == inverteInteiro(numero); }
